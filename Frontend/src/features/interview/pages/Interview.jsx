    ...
    <div className="interview-page">
      <div className="interview-layout">
        ...
        <nav className="interview-nav">
          ...
          <section className="sidebar-recent-plans">
            <p className="interview-nav__label">Recent Plans</p>
            <div className="sidebar-recent-plans__list">
              {reports.map((recentReport) => {
                const recentTitle = recentReport.title || "Interview Position";

                return (
                  <button
                    key={recentReport._id}
                    type="button"
                    className={`sidebar-recent-plans__item ${recentReport._id === interviewId ? "sidebar-recent-plans__item--active" : ""}`}
                    onClick={() => navigate(`/interview/${recentReport._id}`)}
                    title={recentTitle}
                    >
                    <span className="sidebar-recent-plans__title">
                      {recentTitle}
                    </span>
                    <small>{recentReport.matchScore}% match</small>
                  </button>
                );
              })}
            </div>
          ...
          <div className="nav-actions">
            ...
            <button
              ...
              className="button new-report-button"
              type="button"
            >
              Create New Report
            </button>
